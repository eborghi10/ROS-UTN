#! /usr/bin/env python
# https://github.com/merose/diff_drive/blob/master/nodes/diff_drive_go_to_goal
...
from robot_control import goal_controller
from robot_control import pose
from robot_control.msg import GoToPoseAction, GoToPoseGoal, GoToPoseResult
...
class GoToGoalNode:
    ...
    def get_angle_pose(self, quaternion_pose):
        yaw = self.quaternion_to_yaw(quaternion_pose.orientation)
